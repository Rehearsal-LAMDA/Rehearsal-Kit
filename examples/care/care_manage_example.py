#!/usr/bin/env python
"""Manage CARE experiment config for ``rehearsal-run``.

Example:

PYTHONPATH=src python -m rehearsal.experiments.run examples/care/care_manage_example.py \
  --method care --seeds 3 --params n_data=2000 --eval-samples 1000
"""
