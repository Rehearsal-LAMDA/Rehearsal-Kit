#!/usr/bin/env python
"""Bermuda Grad-Rh experiment config for ``rehearsal-run``."""
...
def build_experiment(params, seed):
    ...
    return {
        ...
        "metadata": {
            "dataset": spec.name,
            "source": "examples/grad_rh/bermuda_example.py",
            "reference": "previous_works/04-AAAI 2025/code",
            "data_source": "seeded Bermuda SEM used as Grad-Rh training data",
