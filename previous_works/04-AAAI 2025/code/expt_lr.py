...
if __name__ == '__main__':
    ...
    full_records = {}
    for learning_rate in [0.0001, 0.001, 0.005, 0.01, 0.05, 0.1, 0.2, 0.5, 1.0, 2.0, 4.0, 8.0]:
        ...
        full_records[learning_rate] = records
        ...
        for seed in pbar:
            ...
            pbar.set_description(f'gradient: {rehearsal_prob:.3f}, gradient_time: {records["center_mae_time"][-1]:.3f}')

        torch.save(full_records, f'save/{dataset}_lr.pkl')
