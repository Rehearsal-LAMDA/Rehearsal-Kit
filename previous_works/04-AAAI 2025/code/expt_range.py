    ...
    for r in [0.05, 0.1, 0.2, 0.3, 0.5, 0.7, 1.0, 1.5, 2.0, 2.5, 3.0]:
        ...
        for seed in pbar:
            ...
            pbar.set_description(
                f'gradient: {rehearsal_prob:.3f},' +
                f'gradient_time: {records["center_mae_time"][-1]:.3f},' +
                f'gradient_avg: {np.mean(records["center_mae_prob"]):.3f}')

        torch.save(full_records, f'save/{dataset}_range.pkl')
